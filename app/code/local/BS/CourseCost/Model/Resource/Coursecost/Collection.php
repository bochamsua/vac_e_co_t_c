 ...
 */
/**
 * Course Cost collection resource model
 *
 * @category    BS
 * @package     BS_CourseCost
 * @author Bui Phong
 */
class BS_CourseCost_Model_Resource_Coursecost_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
