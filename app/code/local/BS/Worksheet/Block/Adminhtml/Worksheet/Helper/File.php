 ...
 */
/**
 * Worksheet file field renderer helper
 *
 * @category    BS
 * @package     BS_Worksheet
 * @author Bui Phong
 */
class BS_Worksheet_Block_Adminhtml_Worksheet_Helper_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('bs_worksheet/worksheet')->getFileBaseUrl() . $url;
            }
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('bs_worksheet')->__('Delete File');
