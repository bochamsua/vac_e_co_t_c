 ...
 * @author      Bui Phong
 */
class BS_Bank_Block_Adminhtml_Subject_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        $isAllowedEdit = Mage::getSingleton('admin/session')->isAllowed("bs_bank/subject/edit");
        $isAllowedDelete = Mage::getSingleton('admin/session')->isAllowed("bs_bank/subject/delete");
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_subject') && Mage::registry('current_subject')->getId()) {
            ...
            return Mage::helper('bs_bank')->__('Add Subject');
        }
    }
}
