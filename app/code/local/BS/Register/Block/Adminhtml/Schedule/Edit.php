 ...
 */
/**
 * Course Schedule admin edit form
 *
 * @category    BS
 * @package     BS_Register
 * @author Bui Phong
 */
class BS_Register_Block_Adminhtml_Schedule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_schedule') && Mage::registry('current_schedule')->getId()) {
            return Mage::helper('bs_register')->__(
                "Edit Course Schedule '%s'",
                $this->escapeHtml(Mage::registry('current_schedule')->getScheduleNote())
            );
        } else {
            return Mage::helper('bs_register')->__('Add Course Schedule');
        }
    }
}
