 ...
 * @author Bui Phong
 */
class BS_Tc_Model_Employee_Attribute_Backend_File extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    ...
    public function afterSave($object)
    {
        ...
        $path = Mage::helper('bs_tc/employee')->getFileBaseDir();
