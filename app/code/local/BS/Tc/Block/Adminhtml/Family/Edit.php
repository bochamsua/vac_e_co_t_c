 ...
 */
/**
 * Family admin edit form
 *
 * @category    BS
 * @package     BS_Tc
 * @author Bui Phong
 */
class BS_Tc_Block_Adminhtml_Family_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        if($popup){
            ...
            $this->_addButton(
                'closewindow',
                array(
                    'label'   => Mage::helper('bs_tc')->__('Close'),
    ...
    {
        if (Mage::registry('current_family') && Mage::registry('current_family')->getId()) {
            return Mage::helper('bs_tc')->__(
                "Edit Family '%s'",
                $this->escapeHtml(Mage::registry('current_family')->getFname())
            );
        } else {
            return Mage::helper('bs_tc')->__('Add Member');
        }
    }
}
