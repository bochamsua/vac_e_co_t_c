 ...
 */
/**
 * Adminhtml family attribute edit page main tab
 *
 * @category    BS
 * @package     BS_Tc
 * @author Bui Phong
 */
class BS_Tc_Block_Adminhtml_Family_Attribute_Edit_Tab_Main extends Mage_Eav_Block_Adminhtml_Attribute_Edit_Main_Abstract
{
    /**
     * Adding product form elements for editing attribute
     *
     * @access protected
     * @return BS_Tc_Block_Adminhtml_Family_Attribute_Edit_Tab_Main
     * @author Bui Phong
     */
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('adminhtml_family_attribute_types', array('response'=>$response));
        ...
        Mage::dispatchEvent(
            'bs_tc_adminhtml_family_attribute_edit_prepare_form',
            array(
                'form'      => $form,
