 ...
 * @author Bui Phong
 */
class BS_Tc_Block_Adminhtml_Employee_Attribute_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return BS_Tc_Adminhtml_Employee_Attribute_Edit_Tabs
     * @author Bui Phong
     */
    protected function _beforeToHtml()
    {
        $this->addTab(
            ...
            array(
                ...
                'content'   => $this->getLayout()->createBlock(
                    'bs_tc/adminhtml_employee_attribute_edit_tab_main'
                )
                ->toHtml(),
                'active'    => true
            )
        ...
        $this->addTab(
            ...
            array(
                ...
                'content'   => $this->getLayout()->createBlock(
                    'bs_tc/adminhtml_employee_attribute_edit_tab_options'
                )
                ->toHtml(),
            )
        );
