 ...
 * @author Bui Phong
 */
class BS_Tc_Block_Adminhtml_Employee_Attribute_Grid extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
    /**
     * Prepare employee attributes grid collection object
     *
     * @access protected
     * @return BS_Tc_Block_Adminhtml_Employee_Attribute_Grid
     * @author Bui Phong
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('bs_tc/employee_attribute_collection')
            ->addVisibleFilter();
