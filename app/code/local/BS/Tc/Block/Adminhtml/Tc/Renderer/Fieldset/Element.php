 ...
 * @author Bui Phong
 */
class BS_Tc_Block_Adminhtml_Tc_Renderer_Fieldset_Element extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    /**
    ...
    {
        $this->setTemplate('bs_tc/form/renderer/fieldset/element.phtml');
    }
     ...
     *
     * @access public
     * @return BS_Tc_Model_Resource_Eav_Attribute
     * @author Bui Phong
     */
     ...
     *
     * @access public
     * @return BS_Tc_Block_Adminhtml_Tc_Renderer_Fieldset_Element
     * @author Bui Phong
     */
    ...
    public function getScopeLabel()
    {
        ...
        if ($this->isScopeGlobal($attribute)) {
            $html.= Mage::helper('bs_tc')->__('[GLOBAL]');
        } elseif ($this->isScopeWebsite($attribute)) {
            $html.= Mage::helper('bs_tc')->__('[WEBSITE]');
        } elseif ($this->isScopeStore($attribute)) {
            $html.= Mage::helper('bs_tc')->__('[STORE VIEW]');
        }
        return $html;
    }
