 ...
 * @author Bui Phong
 */
class BS_Certificate_Block_Adminhtml_Crs_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    {
        if (Mage::registry('current_crs') && Mage::registry('current_crs')->getId()) {
            return Mage::helper('bs_certificate')->__(
                "Edit CRS '%s'",
                $this->escapeHtml(Mage::registry('current_crs')->getName())
            );
        } else {
            return Mage::helper('bs_certificate')->__('Add CRS');
        }
    }
}
