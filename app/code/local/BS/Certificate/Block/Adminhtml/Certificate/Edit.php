 ...
 * @author Bui Phong
 */
class BS_Certificate_Block_Adminhtml_Certificate_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->_addButton(
            'saveandcontinue',
            array(
                'label'   => Mage::helper('bs_certificate')->__('Save And Continue Edit'),
        ...
        if($popup){
            ...
            $this->_addButton(
                'closewindow',
                array(
                    'label'   => Mage::helper('bs_certificate')->__('Close'),
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_certificate') && Mage::registry('current_certificate')->getId()) {
            return Mage::helper('bs_certificate')->__(
                "Edit Certificate '%s'",
                $this->escapeHtml(Mage::registry('current_certificate')->getStaffName())
            );
        } else {
            return Mage::helper('bs_certificate')->__('Add Certificate');
        }
    }
}
