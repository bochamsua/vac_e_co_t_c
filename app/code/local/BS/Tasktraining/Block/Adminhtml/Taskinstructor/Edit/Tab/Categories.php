 ...
 */
/**
 * taskinstructor - categories relation edit block
 *
 * @category    BS
 * @package     BS_Tasktraining
 * @author Bui Phong
 */
class BS_Tasktraining_Block_Adminhtml_Taskinstructor_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('bs_tasktraining/taskinstructor/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited instructor
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the instructor is linked to
     *
     * @access public
     * @return array
     * @author Bui Phong
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getTaskinstructor()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param BS_Tasktraining_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current instructor)
     *
     * @return array
     */
