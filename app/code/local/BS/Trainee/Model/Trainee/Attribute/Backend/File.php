 ...
 * @author      Bui Phong
 */
class BS_Trainee_Model_Trainee_Attribute_Backend_File extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
    ...
    public function afterSave($object)
    {
        ...
        $path = Mage::helper('bs_trainee/trainee')->getFileBaseDir();
