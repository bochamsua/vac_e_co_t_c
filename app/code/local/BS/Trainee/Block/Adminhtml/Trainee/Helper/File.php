 ...
 */
/**
 * Trainee file field renderer helper
 *
 * @category    BS
 * @package     BS_Trainee
 * @author      Bui Phong
 */
class BS_Trainee_Block_Adminhtml_Trainee_Helper_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('bs_trainee/trainee')->getFileBaseUrl() . $url;
            }
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('bs_trainee')->__('Delete File');
