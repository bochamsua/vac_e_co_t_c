 ...
 */
/**
 * Workshop - product relation edit block
 *
 * @category    BS
 * @package     BS_Logistics
 * @author Bui Phong
 */
class BS_Logistics_Block_Adminhtml_Workshop_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return BS_Logistics_Block_Adminhtml_Workshop_Edit_Tab_Product
     * @author Bui Phong
     */
    protected function _prepareCollection()
    {
        ...
        if ($this->getWorkshop()->getId()) {
            $constraint = '{{table}}.workshop_id='.$this->getWorkshop()->getId();
        } else {
            $constraint = '{{table}}.workshop_id=0';
        }
    ...
    {
        $products = $this->getWorkshopProducts();
    ...
    {
        $products = array();
        $selected = Mage::registry('current_workshop')->getSelectedProducts();
