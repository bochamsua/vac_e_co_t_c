 ...
 */
/**
 * Equipment admin edit form
 *
 * @category    BS
 * @package     BS_Logistics
 * @author Bui Phong
 */
class BS_Logistics_Block_Adminhtml_Equipment_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            function saveAndContinueEdit(urlTemplate) {
                 ...
                 if(typeof equipment_tabsJsTabs !== 'undefined'){
                    var url = template.evaluate({tab_id:equipment_tabsJsTabs.activeTab.id});
                 }else {
                    var url = template.evaluate({tab_id:equipment_info_tabsJsTabs.activeTab.id});
                 }
            ...
            Event.observe(window, 'load', function() {
                ...
                if (objName != '') {
                    ...
                    if(typeof equipment_tabsJsTabs !== 'undefined'){
                        equipment_tabsJsTabs.setSkipDisplayFirstTab();
                        equipment_tabsJsTabs.showTabContent(obj);
                     }else {
                        equipment_info_tabsJsTabs.setSkipDisplayFirstTab();
                        equipment_info_tabsJsTabs.showTabContent(obj);
                     }
    ...
    {
        if (Mage::registry('current_equipment') && Mage::registry('current_equipment')->getId()) {
            return Mage::helper('bs_logistics')->__(
                "Edit Equipment '%s'",
                $this->escapeHtml(Mage::registry('current_equipment')->getEquipmentName())
            );
        } else {
