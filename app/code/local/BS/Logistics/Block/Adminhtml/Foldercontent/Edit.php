 ...
 */
/**
 * Folder Content admin edit form
 *
 * @category    BS
 * @package     BS_Logistics
 * @author Bui Phong
 */
class BS_Logistics_Block_Adminhtml_Foldercontent_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    {
        if (Mage::registry('current_foldercontent') && Mage::registry('current_foldercontent')->getId()) {
            return Mage::helper('bs_logistics')->__(
                "Edit Folder Content '%s'",
                $this->escapeHtml(Mage::registry('current_foldercontent')->getTitle())
            );
        } else {
            return Mage::helper('bs_logistics')->__('Add Folder Content');
        }
    }
}
