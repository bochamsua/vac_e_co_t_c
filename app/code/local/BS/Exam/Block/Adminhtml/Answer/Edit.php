 ...
 * @author Bui Phong
 */
class BS_Exam_Block_Adminhtml_Answer_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_answer') && Mage::registry('current_answer')->getId()) {
            return Mage::helper('bs_exam')->__(
                "Edit Answer '%s'",
                $this->escapeHtml(Mage::registry('current_answer')->getAnswerAnswer())
            );
        } else {
            return Mage::helper('bs_exam')->__('Add Answer');
        }
    }
}
