 ...
 * @author Bui Phong
 */
class BS_Exam_Block_Adminhtml_Question_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_question') && Mage::registry('current_question')->getId()) {
            return Mage::helper('bs_exam')->__(
                "Edit Question '%s'",
                $this->escapeHtml(Mage::registry('current_question')->getQuestionQuestion())
            );
        } else {
            return Mage::helper('bs_exam')->__('Add Question');
        }
    }
}
