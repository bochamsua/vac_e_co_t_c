 ...
 * @author Bui Phong
 */
class BS_StaffInfo_Block_Adminhtml_Customer_Edit_Tab_Training extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    protected function _prepareLayout(){
        $this->setChild('add_training_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData(array(
                    'label'     => Mage::helper('adminhtml')->__('Add Record'),
                    'onclick'   => 'window.open(\''.$this->getUrl('*/staffinfo_training/new', array('_current'=>false, 'staff_id'=>$this->getCustomer()->getId(),'popup'=>true)).'\',\'\',\'width=1000,height=700,resizable=1,scrollbars=1\')'
                ))
        );
    ...
    public function getMainButtonsHtml()
    {
        ...
        if($this->getFilterVisibility()){
            $html.= $this->getChildHtml('add_training_button');
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(
                    array(
                        'caption' => 'Edit',
                        'url'     => array('base' => '*/staffinfo_training/edit', 'params' => array('popup'=> 1)),
                        'field'   => 'id',
