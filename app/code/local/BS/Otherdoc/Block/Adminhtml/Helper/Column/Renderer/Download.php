 ...
 * @author      Bui Phong
 */
class BS_Otherdoc_Block_Adminhtml_Helper_Column_Renderer_Download extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text
{
    /**
     * render the column
     *
    ...
    public function render(Varien_Object $row)
    {
        ...
        $doc = Mage::getModel('bs_otherdoc/otherdoc')->load($row->getId());

        $file = $doc->getOtherdocFile();

        $url = Mage::helper('bs_otherdoc/otherdoc')->getFileBaseUrl();
        $dir = Mage::helper('bs_otherdoc/otherdoc')->getFileBaseDir();

        $sub = Mage::getModel('bs_otherdoc/otherdoc_attribute_source_otherdoctype')->getOptionFormatted($doc['otherdoc_type']);
