 ...
 * @author Bui Phong
 */
class BS_Otherdoc_Model_Otherdoc_Attribute_Source_Otherdoctype extends Mage_Eav_Model_Entity_Attribute_Source_Table
{
    /**
     * get possible values
     *
    ...
    {
        $source  = Mage::getModel('eav/config')->getAttribute('catalog_product', 'otherdoc_type');
