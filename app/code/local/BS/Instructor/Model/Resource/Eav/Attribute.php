 ...
 * @author      Bui Phong
 */
class BS_Instructor_Model_Resource_Eav_Attribute extends Mage_Eav_Model_Entity_Attribute
{
    const MODULE_NAME   = 'BS_Instructor';
    const ENTITY        = 'bs_instructor_eav_attribute';

    protected $_eventPrefix = 'bs_instructor_entity_attribute';
    ...
    {
        $this->_init('bs_instructor/attribute');
    }
    ...
    protected function _beforeDelete()
    {
        if (!$this->getIsUserDefined()) {
            throw new Mage_Core_Exception(
                Mage::helper('bs_instructor')->__('This attribute is not deletable')
            );
        }
