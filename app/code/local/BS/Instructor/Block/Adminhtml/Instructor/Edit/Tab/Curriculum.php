 ...
 */
/**
 * Instructor - curriculum relation edit block
 *
 * @category    BS
 * @package     BS_Instructor
 * @author      Bui Phong
 */
class BS_Instructor_Block_Adminhtml_Instructor_Edit_Tab_Curriculum extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return BS_Instructor_Block_Adminhtml_Instructor_Edit_Tab_Curriculum
     * @author Bui Phong
     */
    ...
    {
        $curriculums = $this->getInstructorCurriculums();
    ...
    {
        $curriculums = array();
        $selected = Mage::registry('current_instructor')->getSelectedCurriculums();
     ...
     *
     * @access public
     * @param BS_Instructor_Model_Curriculum
     * @return string
     * @author Bui Phong
     */
