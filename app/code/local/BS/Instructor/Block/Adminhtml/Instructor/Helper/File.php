 ...
 */
/**
 * Instructor file field renderer helper
 *
 * @category    BS
 * @package     BS_Instructor
 * @author      Bui Phong
 */
class BS_Instructor_Block_Adminhtml_Instructor_Helper_File extends Varien_Data_Form_Element_Abstract
{
    /**
     * constructor
     *
    ...
    public function getElementHtml()
    {
        ...
        if ($this->getValue()) {
            ...
            if (!preg_match("/^http\:\/\/|https\:\/\//", $url)) {
                $url = Mage::helper('bs_instructor/instructor')->getFileBaseUrl() . $url;
            }
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('bs_instructor')->__('Delete File');
