 ...
 */
/**
 * instructor - categories relation edit block
 *
 * @category    BS
 * @package     BS_Instructor
 * @author      Bui Phong
 */
class BS_Instructor_Block_Adminhtml_Instructor_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('bs_instructor/instructor/edit/tab/categories.phtml');
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getInstructor()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param BS_Instructor_Model_Category|null $parentNodeCategory
