    ...
    protected function _prepareCollection()
    {
        ...
        if($productId){
            ...
            if($cu = $curriculums->getFirstItem()){
                ...
                //get all instructor in this curriculum
                $instructors = Mage::getResourceModel('bs_instructor/instructor_collection')->addCurriculumFilter($curriculumId);
                $instructorIds = array_keys($instructors->toOptionHash());

                $collection = Mage::getResourceModel('bs_instructor/instructor_collection')
                    ->addAttributeToSelect('iname')
                    ->addAttributeToSelect('ivaecoid')
                    ->addAttributeToSelect('iusername')
                    ->addAttributeToSelect('iphone')
                    ->addAttributeToSelect('idivision_department')
                    ->addAttributeToFilter('entity_id', array('in'=>$instructorIds))
                    ->joinField('position',
