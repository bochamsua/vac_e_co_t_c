 ...
 * @author      Bui Phong
 */
abstract class BS_Traininglist_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return BS_Traininglist_Helper_Image_Abstract
     * @author Bui Phong
     */
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|BS_Traininglist_Helper_Image_Abstract)
     * @author Bui Phong
     */
