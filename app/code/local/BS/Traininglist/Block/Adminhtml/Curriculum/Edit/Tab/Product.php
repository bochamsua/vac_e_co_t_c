 ...
 */
/**
 * Training Curriculum - product relation edit block
 *
 * @category    BS
 * @package     BS_Traininglist
 * @author      Bui Phong
 */
class BS_Traininglist_Block_Adminhtml_Curriculum_Edit_Tab_Product extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
     ...
     *
     * @access protected
     * @return BS_Traininglist_Block_Adminhtml_Curriculum_Edit_Tab_Product
     * @author Bui Phong
     */
    protected function _prepareCollection()
    {
        ...
        $collection->joinField(
            'position',
            'bs_traininglist/curriculum_product',
            'position',
    ...
    {
        $products = $this->getCurriculumProducts();
    ...
    {
        $products = array();
        $selected = Mage::registry('current_curriculum')->getSelectedProducts();
     ...
     *
     * @access public
     * @param BS_Traininglist_Model_Product
     * @return string
     * @author Bui Phong
     */
    ...
    /**
     * get the current training curriculum
     *
     * @access public
