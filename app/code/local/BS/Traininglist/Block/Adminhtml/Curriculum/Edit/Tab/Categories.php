 ...
 */
/**
 * curriculum - categories relation edit block
 *
 * @category    BS
 * @package     BS_Traininglist
 * @author      Bui Phong
 */
class BS_Traininglist_Block_Adminhtml_Curriculum_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('bs_traininglist/curriculum/edit/tab/categories.phtml');
        $this->_withProductCount = false;
    }

    /**
     * Retrieve currently edited training curriculum
     *
     * @access public
    ...
    /**
     * Return array with categories IDs which the training curriculum is linked to
     *
     * @access public
     * @return array
     * @author Bui Phong
    ...
    public function getCategoryIds()
    {
        if (is_null($this->_categoryIds)) {
            $categories = $this->getCurriculum()->getSelectedCategories();
            $ids = array();
     ...
     * Returns root node
     *
     * @param BS_Traininglist_Model_Category|null $parentNodeCategory
    ...
    /**
     * Returns array with nodes those are selected (contain current training curriculum)
     *
     * @return array
     */
