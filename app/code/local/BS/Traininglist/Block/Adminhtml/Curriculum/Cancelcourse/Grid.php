 ...
 * @author      Bui Phong
 */
class BS_Traininglist_Block_Adminhtml_Curriculum_Cancelcourse_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('catalog/product')->getCollection()
            ...
            ->addAttributeToFilter('onhold', array('eq'=>1))
        ...
        //$collection->joinAttribute('onhold', 'catalog_product/onhold', 'entity_id', null, 'inner');
    ...
    {
        return $this->getUrl('*/traininglist_curriculum_cancelcourse/grid', array('_current'=>true));
    }
