 ...
 * @author      Bui Phong
 */
class BS_Traininglist_Block_Adminhtml_Curriculum_New_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
            ...
            array(
                ...
                'actions' => array(
                    array(
                        ...
                        'url'     => array('base'=> '*/traininglist_curriculum/edit', 'params'=>array('backto'=>'new')),
                        'field'   => 'id'
                    )
                ),
                'filter'    => false,
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            ...
            array(
                ...
                'url'        => $this->getUrl('*/traininglist_curriculum/massGenerate', array('backto'=>'new')),
    ...
    {
        return $this->getUrl('*/traininglist_curriculum/edit', array('id' => $row->getId(), 'backto'=>'new'));
    }
    ...
    {
        return $this->getUrl('*/traininglist_curriculum_new/grid', array('_current'=>true));
    }
}
