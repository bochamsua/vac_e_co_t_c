 ...
 * @author      Bui Phong
 */
class BS_Traininglist_Block_Adminhtml_Curriculum_Completecourse extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     * constructor
     *
    ...
    {
        $this->_controller = 'adminhtml_curriculum_completecourse';
        $this->_blockGroup = 'bs_traininglist';
        $this->_headerText = Mage::helper('bs_traininglist')->__('Completed Course');
        parent::__construct();
