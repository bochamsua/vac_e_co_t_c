 ...
 */
/**
 * Training Curriculum - Category relation resource model collection
 *
 * @category    BS
 * @package     BS_Traininglist
 * @author      Bui Phong
 */
class BS_Traininglist_Model_Resource_Curriculum_Category_Collection extends Mage_Catalog_Model_Resource_Category_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('bs_traininglist/curriculum_category')),
