 ...
 * @author      Bui Phong
 */
class BS_TraineeDoc_Model_Traineedoc_Attribute_Source_Traineedoctype extends Mage_Eav_Model_Entity_Attribute_Source_Table
{
    /**
     * get possible values
     *
    ...
    {
        $source  = Mage::getModel('eav/config')->getAttribute('catalog_product', 'trainee_doc_type');
