 ...
 * @author      Bui Phong
 */
class BS_CourseDoc_Block_Adminhtml_Helper_Column_Renderer_Download extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text
{
    /**
     * render the column
     *
    ...
    public function render(Varien_Object $row)
    {
        ...
        $doc = Mage::getModel('bs_coursedoc/coursedoc')->load($row->getId());

        $file = $doc->getCourseDocFile();

        $url = Mage::helper('bs_coursedoc/coursedoc')->getFileBaseUrl();
        $dir = Mage::helper('bs_coursedoc/coursedoc')->getFileBaseDir();
