 ...
 * @author Bui Phong
 */
class BS_Docwise_Model_Resource_Inquiry extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('bs_docwise/inquiry', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return BS_Docwise_Model_Resource_Inquiry
     * @author Bui Phong
     */
