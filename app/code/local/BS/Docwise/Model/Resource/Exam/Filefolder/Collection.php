 ...
 * @author Bui Phong
 */
class BS_Docwise_Model_Resource_Exam_Filefolder_Collection extends BS_Logistics_Model_Resource_Filefolder_Collection
{
    /**
    ...
    public function joinFields()
    {
        if (!$this->_joinedFields) {
            $this->getSelect()->join(
                array('related' => $this->getTable('bs_docwise/exam_filefolder')),
                'related.filefolder_id = main_table.entity_id',
                array('position')
            );
