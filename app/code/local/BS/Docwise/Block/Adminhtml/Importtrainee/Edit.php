 ...
 * @author Bui Phong
 */
class BS_Docwise_Block_Adminhtml_Importtrainee_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * constructor
     *
    ...
    public function getHeaderText()
    {
        if (Mage::registry('current_importtrainee') && Mage::registry('current_importtrainee')->getId()) {
            return Mage::helper('bs_docwise')->__(
                ...
                $this->escapeHtml(Mage::registry('current_importtrainee')->getTitle())
            );
        } else {
            return Mage::helper('bs_docwise')->__('Add Import Trainee');
        }
    }
}
