 ...
 * @author Bui Phong
 */
class BS_Docwise_Block_Adminhtml_Helper_Column_Renderer_Questionno extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Input
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $score = $scoreModel->getQuestionNo();

        $html = '<input type="text" ';
        $html .= 'name="questionno[' . $row->getTraineeId() . ']" ';
        $html .= 'value="' . $score . '"';
