 ...
 * @author Bui Phong
 */
class BS_KST_Model_Resource_Kstsubject extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('bs_kst/kstsubject', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return BS_KST_Model_Resource_Kstsubject
     * @author Bui Phong
     */
