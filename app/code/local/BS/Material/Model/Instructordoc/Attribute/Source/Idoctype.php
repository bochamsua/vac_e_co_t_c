 ...
 * @author      Bui Phong
 */
class BS_Material_Model_Instructordoc_Attribute_Source_Idoctype extends Mage_Eav_Model_Entity_Attribute_Source_Table
{
    /**
     * get possible values
     *
    ...
    {
        $source  = Mage::getModel('eav/config')->getAttribute('customer', 'idoc_type');
