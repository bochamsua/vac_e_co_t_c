 ...
 * @author Bui Phong
 */
class BS_Subject_Block_Adminhtml_Helper_Column_Renderer_Relation extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text
{
    /**
     * render the column
     *
    ...
    public function render(Varien_Object $row)
    {
        ...
        return '<a style="color: #eb5e00;" href="'.$this->getUrl($base, $params).'">'.$this->_getValue($row).'</a>';
    }
}
