...
class Ultimate_ModuleCreator_Model_Entity extends Ultimate_ModuleCreator_Model_Abstract
{
    ...
    public function getMenuAcl($padding)
    {
        ...
        /* Added by S2L Solutions <info@s2lsolutions.com> -- Date added: Saturday, April 11, 2015 */
        $text .= $this->getPadding($padding + 1).'<children>'.$eol;
        $text .= $this->getPadding($padding + 2).'<new translate="title"><title>New</title></new>'.$eol;
        $text .= $this->getPadding($padding + 2).'<edit translate="title"><title>Edit</title></edit>'.$eol;
        $text .= $this->getPadding($padding + 2).'<delete translate="title"><title>Delete</title></delete>'.$eol;
        $text .= $this->getPadding($padding + 1).'</children>'.$eol;
